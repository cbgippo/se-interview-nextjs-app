 ...
 * User Security Page
 * 
 * This page implements the WorkOS User Security widget to allow users
 * to control their security settings and authentication preferences.
 * 
 * Features:
  ...
  if (loading && !authToken) {
    return (
      <Flex direction="column" align="center" gap="4" p="6">
        <Heading size="6">Loading Security...</Heading>
      </Flex>
    );
  }
  ...
  return (
    <Flex direction="column" p="6" style={{ minHeight: "100vh" }}>
      <Flex direction="column" gap="4" mb="6">
        ...
        <Text color="gray">
          Manage your password, Multi-Factor Authentication, and security settings.
        </Text>
